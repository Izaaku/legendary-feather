...
PRICING = {
    ...
    'travel_pass': {
        'category': 'traveler',
        'name': 'Travel Pass',
        'tagline': 'For your week abroad',
        'prices': {'eur': 17.99, 'usd': 19.99, 'mxn': 399},
        'billing': 'one_time',
        'duration_days': 7,
        'minutes_openai': 70,
        'minutes_elevenlabs': 0,
        ...
        'features': [
            '70 minutes active for 7 days',
            '100+ languages with natural voice',
            'Face-to-face conversation mode',
            'Mobile PWA — no app store',
            'No subscription — pay once',
            'Perfect for a complete week abroad',
        ],
    },
    'tourist': {
        'category': 'traveler',
        'name': 'Tourist',
        'tagline': 'For weekend getaways',
        'prices': {'eur': 8.99, 'usd': 9.99, 'mxn': 199},
        'billing': 'monthly',
        'minutes_openai': 35,
        'minutes_elevenlabs': 0,
        'voice_cloning_profiles': 0,
    ...
    'tourist_pro': {
        'category': 'traveler',
        'name': 'Tourist Pro',
        'tagline': 'For frequent travelers and digital nomads',
        'prices': {'eur': 26.99, 'usd': 29.99, 'mxn': 599},
        'billing': 'monthly',
        'minutes_openai': 120,
        'minutes_elevenlabs': 0,
        'voice_cloning_profiles': 0,
        ...
        'features': [
            ...
            'For digital nomads, expats and frequent travelers',
        ],
    },
    'payg': {
        'category': 'payg',
        ...
        'prices': {'eur': 0.32, 'usd': 0.32, 'mxn': 6.48},  # per minute (PAYG 40 effective)
        'billing': 'usage',
        ...
        'visible': True,
        'credit_packs': [
            # Each pack has its own Stripe Price ID. Stripe multi-currency
            # Prices automatically pick MXN/EUR/USD based on customer locale.
            {'eur': 11.99, 'usd': 12.99, 'mxn': 259, 'minutes': 40,
             'stripe_price_id': stripe_price('payg_40')},
            {'eur': 26.99, 'usd': 29.99, 'mxn': 599, 'minutes': 110,
             'stripe_price_id': stripe_price('payg_110')},
            {'eur': 49.99, 'usd': 54.99, 'mxn': 1099, 'minutes': 230,
             'stripe_price_id': stripe_price('payg_230')},
        ],
        'stripe_price_id': stripe_price('payg'),  # legacy fallback
        'features': [
            'Emergency top-up — no subscription',
            '40 / 110 / 230 minute packs',
            'Better rate the more you buy',
